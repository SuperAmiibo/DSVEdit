...
REUSED_ENEMY_INFO = {
  ...
  0x6A => {gfx_wrapper: 0x080F8188, sprite: 0x081DF26C, palette: 0x081D03F8}, # headhunter #sprite not right
  0x6B => {gfx_wrapper: 0x080F8720}, # death
  0x6C => {gfx_wrapper: 0x080F8348, sprite: 0x082258fc, palette: 0x081D08C4}, # legion
  0x6D => {gfx_wrapper: 0x080F8684, sprite: 0x08243F0A}, # balore #sprite not right
